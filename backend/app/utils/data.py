...
def delete_project(project_id: str) -> bool:
    ...
    try:
        ...
        # Import Payment model to handle related records
        from app.models_payment import Payment, Subscription
        ...
        subscriptions = Subscription.query.filter_by(project_id=project_id).all()
        ...
        logger.info(f"Deleted project {project_id} and {len(payments)} related payments and {len(subscriptions)} related subscriptions")
        return True
    except Exception as e:
        db.session.rollback()
