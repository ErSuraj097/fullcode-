...
class ApiService {
  ...
  async deleteAccount(password: string, confirmation: string): Promise<{ message: string; deleted_at: string; projects_deleted: number }> {
...
export const authApi = {
  ...
  deleteAccount: (password: string, confirmation: string) => apiService.deleteAccount(password, confirmation),
